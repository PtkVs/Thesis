...
public class BenchmarkBobDS {

    private static Logger LOG = LoggerFactory.getLogger(BenchmarkBobDS.class);
    ...
    public static void main(String[] args) {
        ...
        LOG.info("Total decryption execution time for " + numberOfRuns + " runs: " + totalExecutionTime + " nanoseconds");
        LOG.info("Average decryption execution time per run: " + (totalExecutionTime / numberOfRuns) + " nanoseconds");
    }
}
